...
//Resize Exact Size
//To resize an image to an exact size you can use the following code. 
//First pass in the image we want to resize in the class constructor, 
//then define the width and height with the scale option of exact. 
//The class will now have the create dimensions to create the new image, now call the function 
//saveImage() and pass in the new file location to the new image.
